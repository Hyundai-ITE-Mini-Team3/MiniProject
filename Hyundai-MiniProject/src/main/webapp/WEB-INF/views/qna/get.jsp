...
<div id="bodyWrap">
	...
	<div class="sub_container">
		...
		<div class="sub_cnts">
			...
			<div class="tblwrap">
				<h4 class="tbl_ltype"><strong>${qna.qtitle }</strong></h4>
				<br>
				<p>작성자 : ${qna.mid }</p>
				
				<p><fmt:formatDate pattern="yyyy-MM-dd HH:mm:SS" value="${qna.qdate }" /></p>
				<br>
				<p> ${qna.qcontent }</p>
			</div>
		...
		<div class="btnwrap">
						<a href="/qna/list" class="btn wt">목록으로 돌아가기</a>
						<a href="/qna/modify?qid=${qna.qid }" class="btn gray mr0">수정하기</a>
						</div>
		<!-- //cnts -->
	</div>
</div>
