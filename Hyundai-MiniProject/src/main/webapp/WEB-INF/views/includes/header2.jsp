...
function callChatbot(token, talkId) {
    if(token == null) {
        $.ajax({
            ...
            data: {"CSRFToken":"55d3bf48-0eac-4e64-a506-8cd40764f5b4"},
            async : false,
            success:function(data){
...
//]]>
					...
					<div class="search_box_wrap sbw1803" id="searchBox">
						<form name="search" id="search" action="/ko/hssearch/searchCount"
							...
							<input type="hidden" name="CSRFToken"
								value="55d3bf48-0eac-4e64-a506-8cd40764f5b4"> <input
			...
			<form id="chatbotForm"
				...
				<div>
					<input type="hidden" name="CSRFToken"
						value="55d3bf48-0eac-4e64-a506-8cd40764f5b4">
				</div>
			</form>
			<!-- //headerWrap -->
				...
				<div class="gnb_nav gnb_nav1903 hscene1906 hscene1910">
					...
					<ul class="cate_m cate_banner gnbul1" id="cate_m_main">
							...
							<div class="sub_back" style="height: 0px; border-bottom: 0px;">
								<div class="sub_menu clearfix" style="display: none;">
									<ul class="al_frt1 sm_dep1"
										style="margin-left: 165px; float: right;">
										<li><a href="/ko/c/as"
						...
						<li><a href="/ko/c/be"
							...
							class="">뷰티<i class="ico-new">new</i><span class="arr">arrow</span></a>
							<div class="sub_back" style="height: 0px; border-bottom: 0px;">
								<div class="sub_menu clearfix" style="display: none;">
									<ul class="al_frt1 sm_dep1" style="margin-left: 165px;">
										<li><a href="/ko/c/be"
					...
					<ul class="cate_m cate_banner gnbul2" id="cate_m_main"
						...
						<li><a href="/ko/magazine/exhibitions"
							onclick="GA_Event('공통','GNB','기획전');" class="">기획전<!-- 기획전 --></a></li>
						<li><a href="/ko/magazine/events"
							onclick="GA_Event('공통','GNB','이벤트');" class="">이벤트</a></li>
						<!-- THE 매거진 수정 200330 -->
