...
<script type="text/javascript"
	src="/resources/js/jquery-1.11.2.js"></script>
<!--[if lt IE 9]>
...
<body>
		...
		<div class="sub_container error_container">
			...
			<div class="errorwrap" id="ko">
				...
				<div class="con_error">
					...
					<br>입력한 주소가 정확한지 다시 한번 확인해주시길 바랍니다.
					</span>
				</div>
				<div class="btnwrap">
			...
			<div class="errorwrap" id="en" style="display: none;">
				...
				<div class="con_error">
					...
					<span>The webpage cannot be found.<br>This error is
						...
						been deleted, or changed.<br>
					<br>Make sure the address is correct and try again.
					</span>
				</div>
				<div class="btnwrap">
	...
	<script
		src="http://cr.acecounter.com/Web/AceCounter_CW.js?gc=AP6F40149814536&amp;py=0&amp;gd=dgc17&amp;gp=8080&amp;up=NaPm_Ncisy&amp;rd=1651542287581"
