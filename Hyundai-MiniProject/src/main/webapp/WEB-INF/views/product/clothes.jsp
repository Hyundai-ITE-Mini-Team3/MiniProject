...
<head>
<meta charset="UTF-8">
<title>라이프스타일 > 키즈 > 의류 테스트 페이지</title>
	...
	<div id="bodyWrap" class="products">
		...
		<h3 class="cnts_title ou1804">
			<span> <!-- 정상 브랜드 카테고리 목록 --> <a href="/ko/c/LS/"
				...
				onclick="GA_Event('카테고리_리스트','카테고리','홈')"> 키즈</a> <img
				src="http://cdn.thehandsome.com/_ui/desktop/common/images/products/ou_location_arr.png"
				alt="location arr"> <a href="javascript:void(0);"
				onclick="GA_Event('카테고리_리스트','카테고리','패브릭')"> 의류</a>
			</span>
		</h3>
								...
								<li>
									<div class="item_box">
										<a href="" class="item_info1"
											...
											class="item_img"> <img src="/resources/img/product/clothes/${product.pid }.jpg" id="T01_IMG_0"
