...
function dayClose(cName, cValue, cDay) {
    ...
    <form id="orderSearchForm" action="/ko/mypage/order/myorderlist">
        <input type="hidden" name="sterm" class="input_date" title="기간 입력" id="sterm" value="2022-04-02" readonly="">
        <input type="hidden" name="eterm" class="input_date" title="기간 입력" id="eterm" value="2022-05-02" readonly="">
    </form>
    <!-- 회원정보 -->
    <div class="profile_info1 clearfix review_betterment1905">
            <div class="name type2">
                    <span class="ico_grade">진*서&nbsp;<span>님</span></span>
