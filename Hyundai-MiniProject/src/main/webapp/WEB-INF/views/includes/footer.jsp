			...
			<div class="cnts2_right">
				...
				<div id="noticeWrap" class="notice">
					...
					<div class="list">
						...
						<ul class="list_new" style="top: 0px;"><li><a href="/ko/svcenter/notice?noticeCode=8803728019376">더한섬닷컴 서비스 정상화 안내</a></li></ul>
					</div>
				</div>
				<!-- //공지 -->
				...
				<div id="newsWrap" class="news">
					...
					<div class="list">
						...
						<ul class="list_new" style="top: -20px;"><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8803498645276&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">세상 유일한 무이 스타일 '유일무이' 4화</a></li><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8803465877276&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">[핸썸TV] 딱 지금을 위한! FOURM 에센셜 아이템</a></li><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8803400406812&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">[핸썸TV] 오브제의 22 SUMMER 컬렉션</a></li><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8803498678044&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">세상 유일한 무이 스타일 '유일무이' 3화</a></li></ul>
					</div>
				</div>
				<!-- //뉴스 -->
				<!-- // 푸터 공지 추가 220404 -->
