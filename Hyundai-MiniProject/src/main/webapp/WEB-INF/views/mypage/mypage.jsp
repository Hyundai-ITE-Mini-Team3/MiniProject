...
//     var startDate = new Date('2018/03/23 00:00:00'), endDate = new Date('2018/04/08 23:59:59');
    if (todayDate.getTime() >= startDate.getTime() && todayDate.getTime() <= endDate.getTime()) {
        ...
        var referer = "https://www.thehandsome.com/ko/mypage";
...
// 								html.push('<li><a href="http://www.thehyundai.com/front/dpm/myShopHome.thd?bfp=Ref_Handsome">트렌드샵</a></li>');
	...
	<form id="CSRFForm" action="/ko/mypage" method="post"><div>
...
function dayClose(cName, cValue, cDay) {
    ...
    <form id="orderSearchForm" action="/ko/mypage/order/myorderlist">
        <input type="hidden" name="sterm" class="input_date" title="기간 입력" id="sterm" value="2022-04-03" readonly="">
        <input type="hidden" name="eterm" class="input_date" title="기간 입력" id="eterm" value="2022-05-03" readonly="">
    </form>
    <!-- 회원정보 -->
...
</script><script src="https://cr.acecounter.com/Web/AceCounter_CW.js?gc=AP6F40149814536&amp;py=0&amp;gd=dgc17&amp;gp=8080&amp;up=NaPm_Ncisy&amp;rd=1651562278469" type="text/javascript"></script>
...
<!--layer popup-->
            <div class="popwrap w_type_4" id="addrModPop" style="display:none;">
                <!-- Title1 -->
                <div class="title_wrap">
                    <h4 class="float_left"><spring:theme code="global.delivery.modaddr"><!-- 배송지 수정 --></spring:theme></h4>
                                    ...
                                    <div class="delivery_comt" style="display:none;">
                                        <ul>
                                            <li class="deliveryMsg"><a href="#;" deliveryrequestmessage="배송 전 연락 바랍니다">배송 전 연락 바랍니다</a></li>
                                        			<li class="deliveryMsg" style="background: rgb(248, 248, 248);"><a href="#;" deliveryrequestmessage="부재 시 문 앞에 놓아주세요">부재 시 문 앞에 놓아주세요</a></li>
                                        			<li class="deliveryMsg"><a href="#;" deliveryrequestmessage="부재 시 경비실에 맡겨주세요">부재 시 경비실에 맡겨주세요</a></li>
                                        			<li class="deliveryMsg" style="background: rgb(248, 248, 248);"><a href="#;" deliveryrequestmessage="빠른 배송 부탁드립니다">빠른 배송 부탁드립니다</a></li>
