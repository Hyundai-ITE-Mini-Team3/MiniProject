...
<script type="text/javascript">
		...
		var ACC = { config: {} };
			...
			ACC.config.CSRFToken = "55d3bf48-0eac-4e64-a506-8cd40764f5b4";
...
<script type="text/javascript"
	src="/resources/js/ui.js?20211105"></script>
<script type="text/javascript"
...
//     var startDate = new Date('2018/03/23 00:00:00'), endDate = new Date('2018/04/08 23:59:59');
    if (todayDate.getTime() >= startDate.getTime() && todayDate.getTime() <= endDate.getTime()) {
        ...
        var referer = "http://www.thehandsome.com/ko/c/ls022/";
...
<script
	src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/943253288/?random=1651736491430&amp;cv=9&amp;fst=1651736491430&amp;num=1&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;u_h=1080&amp;u_w=1920&amp;u_ah=1032&amp;u_aw=1920&amp;u_cd=24&amp;u_his=14&amp;u_tz=540&amp;u_java=false&amp;u_nplug=5&amp;u_nmime=2&amp;sendb=1&amp;ig=1&amp;frm=0&amp;url=http%3A%2F%2Fwww.thehandsome.com%2Fko%2F&amp;ref=http%3A%2F%2Fwww.thehandsome.com%2Fko%2Fc%2Fls022%2F&amp;tiba=%EB%8D%94%ED%95%9C%EC%84%AC%EB%8B%B7%EC%BB%B4%20%7C%20THE%20HANDSOME.COM&amp;hn=www.googleadservices.com&amp;rfmt=3&amp;fmt=4"></script>
...
function callChatbot(token, talkId) {
    if(token == null) {
        $.ajax({
            ...
            data: {"CSRFToken":"6b24ead3-8add-4656-bab8-6af835ae6819"},
            async : false,
            success:function(data){
    ...
    <div class="gnb_sh_wrap" style="display:none;">
				...
				<div class="search_box_wrap sbw1803" id="searchBox">
                    <form name="search" id="search" action="/ko/hssearch/searchCount" method="post" onsubmit="return false;">           
                        <input type="hidden" name="CSRFToken" value="6b24ead3-8add-4656-bab8-6af835ae6819">
                    ...
                    <div class="data_react">
                        ...
                        <div class="search_tab">
                            ...
                            <form id="searchStyle" name="searchStyle" action="/ko/hssearch/searchCount" method="post" onsubmit="return false;">
                                ...
                                <input type="hidden" name="collection" value="">
                                <input type="hidden" id="CSRFToken" name="CSRFToken" value="6b24ead3-8add-4656-bab8-6af835ae6819">
        ...
        <div class="gnb_nav gnb_nav1903 hscene1906 hscene1910">
            ...
            <li><a href="/product/lifestyle" onclick="GA_Event('공통','GNB','라이프스타일');GA_Event('공통_카테고리','1DEPTH','라이프스타일');" class="">라이프스타일<span class="arr">arrow</span></a>            
               <div class="sub_back" style="height: 0px; border-bottom: 0px;">
                    ...
                    <li><a href="/product/lifestyle/home" onclick="GA_Event('공통_카테고리','2DEPTH','라이프스타일_홈');">홈</a>
                                    <ul class="clearfix sm_dep2">
                                        <li>
                                                <a href="/product/lifestyle/home/fabric" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_홈_패브릭');">패브릭</a>
                                                    </li>
                                        <li>
                                                <a href="/product/lifestyle/home/fragrances" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_홈_프래그런스');">프래그런스</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li><a href="/product/lifestyle/bath" onclick="GA_Event('공통_카테고리','2DEPTH','라이프스타일_배스');">배스</a>
                                    <ul class="clearfix sm_dep2">
                                        <li>
                                                <a href="/product/lifestyle/bath/bathroom_ware" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_배스_욕실용품');">욕실용품</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li><a href="/product/lifestyle/kitchen" onclick="GA_Event('공통_카테고리','2DEPTH','라이프스타일_키친');">키친</a>
                                    <ul class="clearfix sm_dep2">
                                        <li>
                                                <a href="/product/lifestyle/kitchen/bowl" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_키친_그릇');">그릇</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li><a href="/product/lifestyle/desk" onclick="GA_Event('공통_카테고리','2DEPTH','라이프스타일_데스크');">데스크</a>
                                    <ul class="clearfix sm_dep2">
                                        <li>
                                                <a href="/product/lifestyle/desk/stationery" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_데스크_문구');">문구</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li><a href="/product/lifestyle/kids" onclick="GA_Event('공통_카테고리','2DEPTH','라이프스타일_키즈');">키즈</a>
                                    <ul class="clearfix sm_dep2">
                                        <li>
                                                <a href="/product/lifestyle/kids/clothes" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_키즈_의류');">의류</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                <!--  status2.last end -->
                <li style="margin-right:0px"><a href="/product/lifestyle/pet" onclick="GA_Event('공통_카테고리','2DEPTH','라이프스타일_펫');">펫</a>
                                    <ul class="clearfix sm_dep2">
                                        <li>
                                                <a href="/product/lifestyle/pet/fashion" onclick="GA_Event('공통_카테고리','3DEPTH','라이프스타일_펫_패션');">패션</a>
                                                    </li>
                                        </ul>
                                        </li>                                    
                                </ul>
