...
<script type="text/javascript">
		...
		var ACC = { config: {} };
			...
			ACC.config.CSRFToken = "8af188af-668b-4f8b-8139-edfa4217b13f";
...
<script
	src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/943253288/?random=1651541558637&amp;cv=9&amp;fst=1651541558637&amp;num=1&amp;guid=ON&amp;resp=GooglemKTybQhCsO&amp;u_h=1080&amp;u_w=1920&amp;u_ah=1040&amp;u_aw=1920&amp;u_cd=24&amp;u_his=3&amp;u_tz=540&amp;u_java=false&amp;u_nplug=5&amp;u_nmime=2&amp;sendb=1&amp;ig=1&amp;frm=0&amp;url=https%3A%2F%2Fwww.thehandsome.com%2Fko%2Fmember%2Fjoincomplete&amp;ref=https%3A%2F%2Fwww.thehandsome.com%2Fko%2Fmember%2Fjoininfoform&amp;tiba=%ED%9A%8C%EC%9B%90%EA%B0%80%EC%9E%85%EC%99%84%EB%A3%8C%20%7C%20%EB%8D%94%ED%95%9C%EC%84%AC%EB%8B%B7%EC%BB%B4&amp;hn=www.googleadservices.com&amp;rfmt=3&amp;fmt=4"></script>
...
// 								html.push('<li><a href="http://www.thehyundai.com/front/dpm/myShopHome.thd?bfp=Ref_Handsome">트렌드샵</a></li>');
	...
	<form id="CSRFForm" action="/ko/member/joincomplete" method="post">
		<div>
			<input type="hidden" name="CSRFToken"
				value="8af188af-668b-4f8b-8139-edfa4217b13f">
		</div>
	</form>
	<!-- headerWrap -->
	<div id="headerWrap">
...
function callChatbot(token, talkId) {
    if(token == null) {
        $.ajax({
            ...
            data: {"CSRFToken":"8af188af-668b-4f8b-8139-edfa4217b13f"},
            async : false,
            success:function(data){
				...
				<div class="top_nav_wrap clearfix">
					...
					<div class="search_box_wrap sbw1803" id="searchBox">
						<form name="search" id="search" action="/ko/hssearch/searchCount"
							...
							<input type="hidden" name="CSRFToken"
								value="8af188af-668b-4f8b-8139-edfa4217b13f"> <input
...
var _jid = 'illo00@naver.com' ;			// 가입시입력한 ID
</script>
	<!-- AceCounter END -->
...
//]]>
	...
	<script
		src="https://cr.acecounter.com/Web/AceCounter_CW.js?gc=AP6F40149814536&amp;py=0&amp;gd=dgc17&amp;gp=8080&amp;up=NaPm_Ncisy&amp;rd=1651541558708"
